function [d] = set_map_projection_geoshow(d)
...
showaxes;
grid off;
setm(gca,'maplonlimit',[d.lim(1) d.lim(2)])
setm(gca,'maplatlimit',[d.lim(3) d.lim(4)])
setm(gca,'plabellocation',0.05)
setm(gca,'mlabellocation',0.05)
