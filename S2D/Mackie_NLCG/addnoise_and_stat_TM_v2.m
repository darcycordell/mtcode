...
str='tm_fwd_pred.dat'; %insert your file name here
...
str='stat.txt';    % <<<<<<   insert your output file name here
fid100=fopen(str,'w+');
fprintf(fid100,'%3.0f',log10stat);
fprintf(fid100,'\n')
...
str='input2.tm';    % <<<<<<   insert your output file name here
fid1=fopen(str,'w+');
